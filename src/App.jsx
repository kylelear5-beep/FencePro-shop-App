  ...
  return (
    <div className="app-workspace">
      ...
      <nav className="mobile-app-bar">
        <button className={`m-btn ${activeSection === 'dashboard' ? 'active' : ''}`} onClick={() => setActiveSection('dashboard')}>
          <Home size={20} />
          <span className="m-btn-label">Home</span>
        </button>
        <button className={`m-btn ${activeSection === 'assistant' ? 'active' : ''}`} onClick={() => setActiveSection('assistant')}>
          <MessageSquareQuote size={20} />
          <span className="m-btn-label">Ask Bob</span>
        </button>
        <button className={`m-btn ${activeSection === 'yardcrew' ? 'active' : ''}`} onClick={() => setActiveSection('yardcrew')}>
          <ClipboardList size={20} />
          <span className="m-btn-label">Yard</span>
        </button>
        <button className={`m-btn ${activeSection === 'inventory' ? 'active' : ''}`} onClick={() => setActiveSection('inventory')}>
          <Package size={20} />
          <span className="m-btn-label">Inventory</span>
        </button>
        <button className={`m-btn ${activeSection === 'documents' ? 'active' : ''}`} onClick={() => setActiveSection('documents')}>
          <FolderKanban size={20} />
          <span className="m-btn-label">Docs</span>
        </button>
        <button className={`m-btn ${activeSection === 'tools' ? 'active' : ''}`} onClick={() => setActiveSection('tools')}>
          <Hammer size={20} />
          <span className="m-btn-label">Tools</span>
        </button>
      </nav>
    </div>
  );
